...
int soaMeanShiftCUDA(RgbPixels &points, size_t nOfPoints, float bandwidth, RgbPixels &modes, int* clusters){

}

__global__ void soaMeanShiftCUDA_kernel(RgbPixels &points, size_t nOfPoints, float bandwidth, RgbPixels &modes, int* clusters)
{
